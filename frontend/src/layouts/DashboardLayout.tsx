...
type Tab = 'workflow' | 'history' | 'crm' | 'customer-list' | 'inventory' | 'financial' | 'communication' | 'team';
...
function DashboardLayout() {
  ...
  const navItems = [
    ...
    { id: 'team', label: 'Equipe / Usuários', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', role: 'Admin' },
    ...
    switch (activeTab) {
      ...
      case 'team':
        return (
          <div className="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden flex flex-col h-full">
            <div className="px-6 py-5 border-b border-gray-100 bg-white shrink-0">
              <h3 className="text-xl font-semibold text-gray-800">Equipe & Usuários</h3>
              <p className="text-sm text-gray-500 mt-1">Aprove ou rejeite o acesso de novos mecânicos e membros da oficina.</p>
            </div>
            <div className="p-4 sm:p-8 bg-gray-50/50 flex-grow overflow-auto">
              <TeamManagement />
            </div>
